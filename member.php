...
//var_dump($_SERVER['HTTP_USER_AGENT']);
	...
	while($online = $db->fetch_array($query)) {
		...
		if(	strpos($online['ua'],"Bot")||
			strpos($online['ua'],"bot")||
			strpos($online['ua'],"Googlebot")||
			strpos($online['ua'],"Slurp")||
			strpos($online['ua'],"alexa")||
			strpos($online['ua'],"Sosospider")||
			strpos($online['ua'],"Mediapartners")||
			strpos($online['ua'],"PubSub")||
			strpos($online['ua'],"Ant.com")||
			strpos($online['ua'],"Java")||
			strpos($online['ua'],"spider")||
			strpos($online['ua'],"YoudaoBot")
			)
		{

			$online["bot"]="<font color='red'>爬虫</font>";
		}else{
			$online["bot"]="游客";
		}
		$onlinelist[] = $online;
