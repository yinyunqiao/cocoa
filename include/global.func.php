...
function updatesession() {
	...
	if($sessionexists == 1) {
		...
		$ua_online = $_SERVER['HTTP_USER_AGENT'];
		$refer_online = $_SERVER['HTTP_REFERER'];
		$db->query("INSERT INTO {$tablepre}sessions (sid, ip1, ip2, ip3, ip4, uid, username, groupid, styleid, invisible, action, lastactivity, lastolupdate, seccode, fid, tid,ua,refer)
			VALUES ('$sid', '$ips[0]', '$ips[1]', '$ips[2]', '$ips[3]', '$discuz_uid', '$discuz_user', '$groupid', '$styleid', '$invisible', '$discuz_action', '$timestamp', '$lastolupdate', '$seccode', '$fid', '$tid','$ua_online','$refer_online')", 'SILENT');
