...
// [CH] 如您对 cookie 作用范围有特殊要求, 或论坛登录不正常, 请修改下面变量, 否则请保持默认
	...
	$cookiepre = 'wwv_';			// cookie 前缀
	$cookiedomain = ''; 			// cookie 作用域
	$cookiepath = '/';			// cookie 作用路径

// [CH] 论坛投入使用后不能修改的变量

	$tablepre = 'cocoabbs_';   			// 表名前缀, 同一数据库安装多个论坛请修改此处
...
// [CH] 论坛安全设置, 调整以下设置，可以增强论坛的安全性能和防御性能
	...
	$adminemail = 'admin@tiny4.org';		// 系统管理员 Email
...
define('UC_DBNAME', 'tiny4cocoa');
define('UC_DBCHARSET', 'utf8');
define('UC_DBTABLEPRE', '`tiny4cocoa`.cocoabbs_uc_');
define('UC_DBCONNECT', '0');
define('UC_KEY', '9f47yaF0r6D820xbM076NbG5H8bau7D07fw9Tcv8g1pdafDbf1R9N5h5E464a0P2');
define('UC_API', 'http://tiny4cocoa.com/uc_server');
